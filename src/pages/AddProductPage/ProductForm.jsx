  ...
  return (
    <>
      <div className="flex flex-col p-8">
        <form className="grid grid-cols-1 md:grid-cols-2 items-start gap-8">
          ...
          <div className="flex flex-col p-5 gap-6 bg-bg-card rounded-3xl shadow border border-border">
            ...
            <div className="flex flex-col gap-3">
              ...
              <input
                ...
                className="w-full bg-info-bg/25 py-2.5 px-3 text-sm text-text-primary placeholder:text-text-muted/50 border border-border rounded-md outline-0 focus:ring-2 focus:ring-primary/30 dark:focus:ring-primary/70 transition-all duration-200"
              />
              {errors.name && (
              ...
              <div className="flex flex-col gap-3 grow">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-info-bg/25 py-2.5 pl-3 pr-10 text-sm text-text-primary placeholder:text-text-muted/50 border border-border rounded-md outline-0 focus:ring-2 focus:ring-primary/30 dark:focus:ring-primary/70 transition-all duration- [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none [appearance:textfield]"
                  />
                  ...
                  <div className="absolute right-1 top-1/2 -translate-y-1/2 flex flex-col">
                    <button
                      ...
                      className="flex h-4 w-6 text-xs items-center justify-center text-text-muted hover:text-primary transition-colors"
                    >
                      ▲
                    </button>
            ...
            <div className="grid grid-cols-2 gap-6 justify-between">
              ...
              <div className="flex flex-col gap-3 grow">
                ...
                <Select
                  ...
                  displayEmpty
                  className={`!w-full !h-10.5 !bg-info-bg/25 !text-sm ${formData.category ? "!text-text-primary" : "!text-text-muted/50"} !rounded-md !outline-0 !transition-all !duration-200 [&_.MuiOutlinedInput-notchedOutline]:!border-1 [&_.MuiOutlinedInput-notchedOutline]:!border-border [&.Mui-focused_.MuiOutlinedInput-notchedOutline]:!border-0 [&.Mui-focused_.MuiOutlinedInput-notchedOutline]:!ring-2 [&.Mui-focused_.MuiOutlinedInput-notchedOutline]:!ring-primary/30 dark:[&.Mui-focused_.MuiOutlinedInput-notchedOutline]:!ring-primary/70 [&_.MuiSelect-icon]:!text-text-primary/60`}
                  MenuProps={{
                    slotProps: {
                      paper: {
                        className:
            ...
            {/* Tags */}
            <div className="flex flex-col gap-3 w-full bg-info-bg/25 py-2.5 px-4 border border-border rounded-md">
              <label
                htmlFor="tags"
                className="text-text-primary/60 dark:text-text-primary/90 text-sm font-semibold"
              >
              ...
              <div className="flex gap-4 justify-between items-center">
                <input
                  ...
                  className="w-full bg-white/3.5 py-3.5 px-3 text-sm text-text-primary placeholder:text-text-muted/50 border border-border/70 rounded-md outline-0 focus:ring-2 focus:ring-primary/30 dark:focus:ring-primary/70 transition-all duration-200"
                />
                <Button
                  variant="contained"
                  onClick={() => {
                  ...
                  className=" !min-w-0 !rounded-md !px-3.5 !py-2.5 !bg-primary/80 hover:!bg-primary-hover/70 isActive:!bg-primary-isActive !text-white"
                >
                  <svg
                ...
                <div className="flex gap-2 flex-wrap mt-2">
                  {formData.tags.map((tag, index) => (
                    <Chip
                      ...
                      sx={{ boxShadow: "0 0 0" }}
                      deleteIcon={
                        <IconButton className="!flex !items-center !justify-center !bg-black/10 dark:!bg-black/25 !text-white !size-4.75">
                          <CloseIcon className="!text-[14px]" />
                        </IconButton>
                      }
                      className="!bg-primary/25 dark:!bg-primary/65 !font-semibold !text-text-primary/85 backdrop-blur-xl border border-white/30 shadow-xl !shadow-sn"
                      label={tag}
                      onDelete={() =>
                        setFormData({
                          ...formData,
            ...
            <div className="flex justify-center md:justify-start gap-4">
              {/* Featured */}
              <div className="flex items-center rounded-2xl border border-border bg-info-bg/25 px-3 py-1.5">
                <FormControlLabel
                  ...
                  control={
                    <Checkbox
                      size="small"
                      className="!text-primary [&.Mui-checked]:!text-primary [&_.MuiSvgIcon-root]:!text-[18px] !p-0 !mr-2"
                    />
                  }
                  label="Featured"
                  slotProps={{
            ...
            <div className="flex justify-center md:justify-end items-center gap-3">
              <Button
                variant="outlined"
                type="button"
                className="!capitalize !rounded-md !px-5 !py-2.5 !border-border !text-text-secondary hover:!bg-bg-hover hover:!border-secondary/40 transition-all"
              >
                Cancel
              </Button>
              ...
              <Button
                ...
                className="!capitalize !font-semibold !rounded-md !px-4 !py-2.5 !bg-primary/80 hover:!bg-primary-hover/70 disabled:!opacity-70 !text-white !flex !items-center !gap-2"
              >
                {loading && (
                  <CircularProgress
                    size={18}
